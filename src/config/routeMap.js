...
export default [
  { path: "/dashboard", component: Dashboard, roles: [Role.User] },
  { path: "/teach", component: Teach, roles: [Role.User] },
  { path: "/guide", component: Guide, roles: [Role.User] },
  { path: "/permission/explanation", component: Explanation, roles: [Role.User] },
  { path: "/permission/adminPage", component: AdminPage, roles: [Role.User] },
  { path: "/permission/guestPage", component: GuestPage, roles: [Role.User] },
  { path: "/permission/editorPage", component: EditorPage, roles: [Role.User] },
  { path: "/components/richTextEditor", component: RichTextEditor, roles: [Role.User] },
  { path: "/components/Markdown", component: Markdown, roles: [Role.User] },
  { path: "/components/draggable", component: Draggable, roles: [Role.User] },
  { path: "/charts/keyboard", component: KeyboardChart, roles: [Role.User] },
  { path: "/charts/line", component: LineChart, roles: [Role.User] },
  { path: "/charts/mix-chart", component: MixChart, roles: [Role.User] },
  { path: "/nested/menu1/menu1-1", component: Menu1_1, roles: [Role.User] },
  { path: "/nested/menu1/menu1-2/menu1-2-1", component: Menu1_2_1, roles: [Role.User] },
  { path: "/table", component: Table, roles: [Role.User] },
  { path: "/excel/export", component: ExportExcel, roles: [Role.User] },
  { path: "/excel/upload", component: UploadExcel, roles: [Role.User] },
  { path: "/zip", component: Zip, roles: [Role.User] },
  { path: "/clipboard", component: Clipboard, roles: [Role.User] },
  { path: "/user", component: User, roles: [Role.User] },
  { path: "/about", component: About, roles: [Role.User] },
